...
class TestEmbeddings(unittest.TestCase):
    ...
    def test_embedding_model_enum(self):
        ...
        self.assertEqual(EmbeddingModel.INTFLOAT_LARGE.value, "intfloat/multilingual-e5-large-instruct")
        self.assertEqual(EmbeddingModel.INTFLOAT_BASE.value, "intfloat/multilingual-e5-base")
        self.assertEqual(EmbeddingModel.INTFLOAT_SMALL.value, "intfloat/multilingual-e5-small")
